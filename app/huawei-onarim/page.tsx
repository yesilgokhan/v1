...
export default function HuaweiOnarimPage() {
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="bg-gradient-to-br from-red-600 via-red-700 to-orange-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Huawei Onarım Hizmetleri</h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Huawei cihazlarınız için profesyonel onarım çözümleri. Orijinal parçalar, uzman teknisyenler ve hızlı
              servis garantisi.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Kırık, çizik veya dokunmatik sorunu yaşayan Huawei ekranlarınızı orijinal kalitede parçalarla
                değiştiriyoruz.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Şarj tutmayan, hızla biten veya şişen Huawei bataryalarınızı orijinal kapasiteli bataryalarla
                değiştiriyoruz.
              </p>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                <li className="flex items-center">
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-orange-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Huawei Cihazınızı Hemen Onaralım!</h2>
